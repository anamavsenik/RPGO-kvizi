...
%Pomembno je da premisliš, katere koordinate imaš ti in o čem govori
%naloga, tukaj naprimer so v matriki drugače razvrščeni indeksi, kot bi
%mislil direktno, torej moraš nekje gledati vrstice, drugje stolpce. 

[n, m]=size(Bx);
m=m-1;
n=n-1;

[b1x, b2x, b3x] = deal(zeros(n+1, m+1)); %vzame vrednosti zeros in jih priredi matrikam b1x, b2x, b3x
